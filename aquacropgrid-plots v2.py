...
SUMMARY_PKL   = os.path.join(_BASE, '../high_plains_package/outputs/summary_results_20260521_191549.pkl')
DAILY_PKL     = os.path.join(_BASE, '../high_plains_package/outputs/daily_results_20260521_191549.pkl')
GEOJSON_PATH  = os.path.join(_BASE, '../high_plains_package/inputdata/high_plains/high_plains.geojson')
PROCESSED_DIR = os.path.join(_BASE, '../high_plains_package/processed')
EXPORT_DIR    = os.path.join(_BASE, '../high_plains_package/outputs/exports')
